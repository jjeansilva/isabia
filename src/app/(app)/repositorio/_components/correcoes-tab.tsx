...
import { Search, Loader2, Trash2, Edit, Flag } from "lucide-react";
import { Questao, Resposta, Revisao } from "@/types";
        ...
        <Card>
          <CardHeader>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  ...
                  <Button onClick={handleCheckDuplicates} disabled={isCheckingDuplicates || isLoadingQuestoes}>
